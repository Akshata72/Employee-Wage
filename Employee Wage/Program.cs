class EmpwageBuilderObject
{
    ...
    public EmpwageBuilderObject(string Company,int EmpRatePerHour, int FullTime_WorkingHrs_PerDay, int PartTime_WorkingHrs_PerDay, int MAX_WORKING_HR, int MAX_WORKING_DAY)
    {
    ...
    static void Main(string[] args)
    {
        ...
        EmpwageBuilderObject dMart = new EmpwageBuilderObject("dMart",20, 8, 4, 100, 20);
        dMart.CalculateWage("dMart");
        EmpwageBuilderObject TATA = new EmpwageBuilderObject("TATA", 20, 8, 4, 100, 20);
